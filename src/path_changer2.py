...
def callback1(data):
	...
	print "check check check"
        os.system("rosrun dynamic_reconfigure dynparam set car3/move_base_node base_local_planner pose_follower/PoseFollower")
...
def path_changer2():
    pub1 = rospy.Subscriber('car3/amcl_pose', PoseWithCovarianceStamped,callback1)
    pub2 = rospy.Subscriber('car3/move_base_simple/goal', PoseStamped,callback2)
